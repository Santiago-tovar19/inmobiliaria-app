...
export class LandingComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.getPropertysList({}, { page: 1, perPage: 10 });
	}

	getPropertysList(search: any, PaginatorParams: any = { page: 1, perPage: 10 }): void {
		this._propertiesService.getList({}).subscribe(
			(response: any) => {
