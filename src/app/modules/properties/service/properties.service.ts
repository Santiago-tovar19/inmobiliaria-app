...
export class PropertiesService {
	...
	registerView(userID: string, propertyID: string, brokerID: string): Observable<any> {
		return this._httpClient.post<any>(`${environment.api}/properties/register-view`, { userID, propertyID, brokerID });
	}
	...
	registerAppointment(propertyID: any, email: string, phone: string, message: string): Observable<any> {
		const data = {
		...
		return this._httpClient.post<any>(`${environment.api}/appointments`, data);
	}
}
